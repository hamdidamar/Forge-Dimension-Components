...
//import registerTransformTool from './CustomExtension/transformtool';
import * as dragDrop from './DragDropControls.js';
//import registerAddNewModelTool from './CustomExtension/addNewModelExtension';
//import registerAddPartTool from './CustomExtension/addingPartExtension';
import RegisterNewExtTool from './CustomExtension/newExt';
import registerEditModelTool from './CustomExtension/editExtension';
//import ModelTransformerExtension from './CustomExtension/modelTransformer';
...
export class ForgeView extends Component {
    ...
    handleScriptLoad() {
        ...
        //registerAddNewModelTool();
        //registerTransformTool();
        //registerAddPartTool();
        RegisterNewExtTool();
        registerEditModelTool();
        const container = this.viewerDiv.current;
        this.viewer = new Autodesk.Viewing.GuiViewer3D(container, { extensions: ["NewExtToolExtension","EditModelToolExtension"]});
    ...
    render() {
        return (
            <div className="modelContainer fullheight">
                <Message/>
                <div className="viewer" onDragOver={dragDrop.onDragOver} onDrop={dragDrop.onDrop} id="ForgeViewer">
